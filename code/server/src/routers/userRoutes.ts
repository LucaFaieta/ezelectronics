...
class UserRoutes {
    ...
    initRoutes() {
         ...
         */
        this.router.get(
            "/", this.authService.isLoggedIn, this.authService.isAdmin, this.errorHandler.validateRequest,
         ...
         */
        this.router.get(
            "/roles/:role", param("role").isString().isIn(["Admin", "Manager", "Customer"]),
        ...
        this.router.get(
            ...
            this.authService.isLoggedIn, this.errorHandler.validateRequest,
         ...
         */
        this.router.patch(
            "/:username", param("username").notEmpty().isString(),
            this.authService.isLoggedIn,
            [body("name").notEmpty(),
            body("surname").notEmpty().isString(),
            body("address").notEmpty().isString(),
            body("birthdate").notEmpty().isString().custom((value) => {
                if (value) {
...
class AuthRoutes {
    ...
    initRoutes() {
         ...
         */
        this.router.delete(
            "/current", this.authService.isLoggedIn,
